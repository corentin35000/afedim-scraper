...
const (
	...
	TelegramChannel  = "@annonceimmobiliers"                            // Nom d'utilisateur public du canal public (https://t.me/annonceimmobiliers), pour les tests utilisé : https://t.me/annonceimmobiliersafidim
